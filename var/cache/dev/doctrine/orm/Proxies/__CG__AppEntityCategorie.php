...
class Categorie extends \App\Entity\Categorie implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Categorie' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Categorie' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Categorie' . "\0" . 'produits', '' . "\0" . 'App\\Entity\\Categorie' . "\0" . 'user'];
        }
     ...
     * {@inheritDoc}
     */
    public function setId($id): \App\Entity\Categorie
    {
